...
tags: ["query:edu-llm"]
score: 9.0
evidence: 基于生成式AI的信息搜索与学习工具，带有元认知提示
...
motivation: 生成式AI搜索工具往往导致用户产生认知卸载和被动参与，缺乏对信息的批判性验证和深度思考。
method: 开发了MetaCues交互工具，通过在AI搜索结果旁提供元认知提示和笔记界面，引导用户进行信息寻求和意义构建。
result: 实验发现MetaCues提升了用户对判断的信心，并促使他们在不熟悉的主题上进行更广泛的探索。
