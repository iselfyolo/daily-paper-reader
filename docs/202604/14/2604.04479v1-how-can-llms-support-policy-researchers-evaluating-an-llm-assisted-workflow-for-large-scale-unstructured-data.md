...
date: 2026-04-06
pdf: "https://arxiv.org/pdf/2604.04479v1"
tags: ["query:ds-gen"]
score: 6.0
...
## 摘要
政策研究人员需要可扩展的方法来挖掘公众观点，但他们通常依赖于访谈、听证会和调查——并对其进行主题分析——这些方法不仅耗时、昂贵，而且在规模和多样性方面存在局限。大语言模型（LLMs）为非结构化文本的主题分析提供了新的可能性，但我们对大语言模型辅助的工作流在政策研究中的表现知之甚少。基于一种针对在线论坛的大语言模型辅助主题分析工作流，我们对 11 名政策研究人员进行了一项研究，他们使用了一个早期原型，并将其视为研究中一种快速、初步的输入。随后，我们扩展并规模化了该工作流，以分析数百万条 Reddit 帖子和 1,058 份关于政策相关话题的聊天机器人引导访谈转录文本，将这些来源视为政策话语中丰富且可扩展的数据。我们将综合出的主题与权威政策报告中的主题进行了对比，识别了其中的一致点与分歧点，并讨论了这对于采用大语言模型辅助工作流的政策研究人员的启示。
